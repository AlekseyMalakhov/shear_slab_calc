    ...
    */
    ...
    for (var i = 0; i < angles.length; i++) {              //берем отверстие 1
        for (var j = i + 1; j < angles.length; j++) {           //берем отверстие 2 
            ...
            console.log(angle1_1);
            console.log(angle1_2);
            console.log(angle2_1);
            console.log(angle2_2);
            ...
            console.log(coord1_1);
            console.log(coord1_2);
            console.log(coord2_1);
            console.log(coord2_2);
            ...
            if (checkOverlap(triang_1, triang_2)) {
                ...
                console.log(new_angles.length);
                console.log("new ang after merge " + new_angles);
...
function mergeOpenings(opening_tangents) {              //пробуем слить пересекающиеся все треугольники касательных  в один
    ...
    */
    ...
    if (prelim_result_new.length === prelim_result_old.length) {     // если слияние не нашли (или слияний больше нет) старый эррей равен новому - возвращаем что получили
        ...
        /*
        if (prelim_result_old.length === 0) {                         // проверяем не находили ли мы его ранее
            return angles;                                     // если не находили и ранее, значит выдаем исходный эррей - слияние не обнаружено вообще;
        }
        if (prelim_result_old.length > 0) {
            */
            /*
            angles = [];
            ...
            */
            /*
           return prelim_result_old;      // если находили пересечение ранее, то выдаем последний полученный эррей
        }
          */
    }  
}
...
var uCornersAngles_test = [298.909, 61.091, 118.909, 241.091];
var mid_tans_test = [0, 3.399, 299.826, 139.197, 94.606];
var angles_test_3 = [
    [257.471, 62.103],
    [111.371, 154.179],
];
